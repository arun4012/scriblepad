        ...
        <div className="relative w-full">
            <textarea
                ...
                className={cn(
                    ...
                    isTitle
                        ? "text-3xl md:text-4xl font-bold text-gray-800 dark:text-white h-auto"
                        : "text-lg text-gray-700 dark:text-gray-200 min-h-[300px] leading-relaxed",
                    className
                )}
            ...
            {showCharCount && !isTitle && (
                <div className="text-right text-sm text-gray-400 dark:text-gray-500 mt-2 select-none">
